...
namespace UnitTest
{
    ...
    public class TestEmployeeBase
    {
        ...
        /// <summary>
        /// Creates the client employee type for WCF Service
        /// </summary>
        /// <returns>ServicePoxry.AWServiceReference.Employee</returns>
        public ServicePoxry.AWServiceReference.Employee CreateClientEmployee()
        {
            var employee = new ServicePoxry.AWServiceReference.Employee
            {
                ManagerID = 2,
                ContactID = 3,
                Title = "Developer",
